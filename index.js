...
const vcard = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            ...
            + 'FN: Razu\n' //ganti nama bot lu
            + 'ORG: iKarazu;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6281317418547:+6281317418547\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix =''  // Ganti Aja Terserah Lu 
blocked = []   //Jangan Ganti
limitawal = 30 //Bebas Ganti Limit
memberlimit = 1
cr = '*Razu BOT*' 

/******** OWNER NUMBER**********/
const ownerNumber = ["6281317418547@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["6285159680011@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
  ...
  break	
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6281317418547 20`)
		...
		case 'jadwalbola': 			
				...
				for (let i of data.result.data) {
					teks += `𖣘 *Kick Off* : ${i.kickoff}\n𖣘 *Pertandingan* : ${i.pertandingan}\n𖣘 *Stasiuntv* : ${i.stasiuntv}\n\n=================\n\n`
					}
				reply(teks.trim())
				await limitAdd(sender)
				break
...
if (isBanned) return reply('```Lu kebanned kontol```')
		...
		case 'randomhentai':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					reply(ind.wait())
                                        anu = await fetchJson(`https://pkkey.herokuapp.com/api/nsfw/hentai?apikey=Alphabot`, {method: 'get'})
		...
		case 'menu':
            //Gk Ush Di Hapus Tod, Dh Susah" Ngefix Di Hapus Sofun kh bgitu?:v
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    ...
                    shiz = `◪ INFO DEVELOPER
Nama : 𝚒𝙺𝚊𝚛𝚊𝚣𝚞
WhatsApp : Wa.me/6281317418547
Gmail : sendalganz09@gmail.com
ig : shk.razu
  ----------------------------------
◪ YOUR INFO
  𖣘 Prefix : multi prefix
  𖣘 Nama : ${pushname}
  𖣘 Duit : *Rp.${uangku}.-*
  𖣘 Role : *${role}*
  𖣘 Level : ${getLevelingLevel(sender)}
  𖣘 Xp : ${getLevelingXp(sender)}/${reqXp} 
  𖣘 Nomer : wa.me/${sender.split("@")[0]}
  ----------------------------------
   *◪ ABOUT BOT*
𖣘 Name : ${client.user.name}
𖣘 Browser : ${client.browserDescription[1]}
𖣘 Server : ${client.browserDescription[0]}
𖣘 Version : ${client.browserDescription[2]}
𖣘 Speed : ${process.uptime()}
𖣘 Handphone : ${client.user.phone.device_manufacturer}
𖣘 Versi Whatsapp : ${client.user.phone.wa_version}
   ----------------------------------
...
𖣘 *${prefix}hargaprem*
  ...
  *◪ GROUP MENU*
𖣘 ${prefix}welcome [1/0]
𖣘 ${prefix}nsfw [1/0]
𖣘 ${prefix}antivirtex [1/0]
𖣘 ${prefix}antilink [1/0]
𖣘 ${prefix}antilinktele [1/0]
𖣘 ${prefix}antilinkyt [1/0]
𖣘 ${prefix}antilinkig [1/0]
𖣘 ${prefix}leveling [1/0]
𖣘 ${prefix}nobadword [1/0]
𖣘 ${prefix}simih [1/0] 
𖣘 ${prefix}promote [@tag]
𖣘 ${prefix}demote [@tag]
𖣘 ${prefix}tagall
𖣘 ${prefix}listadmin
𖣘 ${prefix}wakillist
𖣘 ${prefix}premiumlist
𖣘 ${prefix}banlist
𖣘 ${prefix}blocklist
𖣘 ${prefix}linkgc
𖣘 ${prefix}mining
...
𖣘 ${prefix}lovemsg
𖣘 ${prefix}mugflower
𖣘 ${prefix}narutobanner
𖣘 ${prefix}paperonglass
𖣘 ${prefix}romancetext
𖣘 ${prefix}shadowtext
𖣘 ${prefix}coffeecup
𖣘 ${prefix}coffeecup2
𖣘 ${prefix}glowingneon
𖣘 ${prefix}underwater
𖣘 ${prefix}hpotter
𖣘 ${prefix}woodblock
𖣘 ${prefix}ttp
...
𖣘 ${prefix}crossgun
𖣘 ${prefix}bakar
𖣘 ${prefix}facebookpage
𖣘 ${prefix}costumwp
𖣘 ${prefix}pantaimalam
𖣘 ${prefix}pencil
...
𖣘 ${prefix}brainly 
𖣘 ${prefix}pinterest
𖣘 ${prefix}resepmasakan
𖣘 ${prefix}igstalk
𖣘 ${prefix}bitly
𖣘 ${prefix}tiktokstalk 
𖣘 ${prefix}ssweb
𖣘 ${prefix}kbbi
𖣘 ${prefix}meme
𖣘 ${prefix}memeindo
...
𖣘 ${prefix}hamster
𖣘 ${prefix}kelinci
𖣘 ${prefix}freefireimg
𖣘 ${prefix}ww2
𖣘 ${prefix}shota
𖣘 ${prefix}neko
 
  *◪ QUOTES MENU*
𖣘 ${prefix}quotesislami
𖣘 ${prefix}quotesnasehat
𖣘 ${prefix}quotesmotivasi
𖣘 ${prefix}quoteskehidupan

 *◪ LIMIT & UANG*
𖣘 ${prefix}limit
𖣘 ${prefix}buylimit
𖣘 ${prefix}buypremiumlimit
𖣘 ${prefix}transfer
𖣘 ${prefix}leaderboard
...
break
		...
		case 'level':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					resul = `◪ *LEVEL*\n  ├─ 𖣘 *Name* : ${pushname}\n  ├─ 𖣘 *Nomor* : ${sender.split("@")[0]}\n  ├─ 𖣘 *User XP* : ${userXp}/${requiredXp}\n  └─ 𖣘 *User Level* : ${userLevel}\n`
...
caption: teks, contextInfo: {
  ...
  break
		...
		case 'lpr':
					...
					client.sendMessage('6281317418547@s.whatsapp.net', options, text, {quoted: faketroli})
    ...
    case 'linkgc':
		...
		case 'hargapremium':
					...
					break
		case 'buypremium':
					client.sendMessage(from, 'Ingin membeli premium?\nHarap hubungi kami : wa.me/6281317418547',MessageType.text, { quoted: faketroli} )
					break
...
case 'simi': 
       ...
       if (budy.includes(`@6281317418547`)) {
